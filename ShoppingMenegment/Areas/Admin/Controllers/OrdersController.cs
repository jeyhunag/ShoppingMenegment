...
namespace ShoppingMenegment.Areas.Admin.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(ShoppingMenegmentContext context)
        {
            _context = context;
        }
        ...
        {
            var shoppingMenegmentContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShoppingMenegmentContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
